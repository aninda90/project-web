        ...
        <div class="admin-content col-md-9 col-sm-12">
            ...
            <div class="content">
                ...
                <form action="create.php" method="post">
                    <!-- Note: Removed name="id" as it may not be necessary -->
                    <div>
                        <label>Nama</label>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="body" required></textarea>
                    </div>
                    <button type="submit" name="add-topic" class="btn btn-primary btn-sm">Add Topic</button>
                </form>
            </div>
